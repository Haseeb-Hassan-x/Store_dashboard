...
function BlueCard({ title, orderCount, amount }) {
    return (
        <div className="rounded overflow-hidden text-white">
            ...
            <div className="bg-white shadow-xl p-5 grid gap-y-4 hover:bg-slate-800 text-black hover:text-white">
            ...
            <div className="text-sm bg-slate-800 flex justify-between py-2 px-6">
